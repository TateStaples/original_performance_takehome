...
\midrule
\code{valu}  & 6{,}209 & 98.3\% (floor $6209/6 = 1035$ cyc) & --- \\
\code{alu}   & 12{,}169 & 96.3\% & --- \\
\code{load}  & 1{,}924 & 91.4\% (1{,}875 gathers) & --- \\
\code{flow}  & 637 & 60.5\% & --- \\
\code{store} & 38 & 1.8\% & --- \\
\midrule
\multicolumn{4}{l}{\emph{work by purpose (lane-ops, \% of total 68{,}801):}}\\
Hash    & & & 46{,}656 \ (67.8\%) \\
Routing & & & 12{,}409 \ (18.0\%) \\
Index   & & & \phantom{0}9{,}144 \ (13.3\%) \\
Setup/Store & & & \phantom{00}592 \ (0.9\%) \\
\bottomrule
\end{tabular}
\end{center}
